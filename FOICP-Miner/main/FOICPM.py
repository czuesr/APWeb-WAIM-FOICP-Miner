...
# Form implementation generated from reading ui file 'FOICPM.ui'
#
...
listsNum=['1st','2nd','3rd ','4th','5th','6th','7th','8th','9th','10th','11th','12th','13th','14th','15th','16th','17th','18th','19th','20th','21th','22th']
...
"color: purple;")
    ...
    def openfile(self):
        ...
        openfile_name = QFileDialog.getOpenFileName(None, 'choose fuzzyontology file', 'F:\pythonITEM\pycharmITem\FuzzOntoInteractively')
        self.filepath1 = openfile_name[0]
    ...
    def openfile1(self):
        ...
        openfile_name = QFileDialog.getOpenFileName(None, 'choose data file', 'F:\pythonITEM\pycharmITem\FuzzOntoInteractively')
        self.filepath2 = openfile_name[0]
    ...
    def startInteractively(self):
        ...
        dicOntology = getOntology(self.filepath1).getOntology()
        datafile = "frequentData3.data"
        data = load_data(self.filepath2).get_data()
        reNum = len(data)
        favList = []
